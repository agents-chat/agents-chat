...
def build_task_brief(
    ...
    *,
    ...
    elif report.get("bootstrap_verify"):
        lines.extend([
            "DONE WHEN: create and run one real, deterministic, noninteractive "
            "verification gate that Agents Chat can auto-detect.",
            "VERIFICATION BOOTSTRAP: use a package.json test/check/build script, "
            "pytest configuration with meaningful tests, or a Makefile test target. "
            "Do not add an always-passing placeholder. A preview or a claimed "
