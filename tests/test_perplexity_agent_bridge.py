...
"""
    ...
    def test_driver_source_selects_folder_before_sending(self):
        ...
        self.assertIn("folderChooserRoot(perplexityRoot)", source)
        self.assertIn("workspaceFolderChipCount", source)
        self.assertIn("clearUnsentComposer", source)
        self.assertIn("removeWorkspaceFolder", source)
        self.assertIn('"Remove Workspace"', source)
